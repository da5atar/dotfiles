...
opt.autoindent = true -- Copy indent from the current line
--
...
-- Searching
opt.ignorecase = true -- Ignore case if all search characters in lower case
...
-- Buffer
opt.colorcolumn = "80" -- show a column at 80 chars
opt.encoding = "utf-8" -- Set encoding
opt.scrolloff = 999 -- number of lines to keep above/below cursor
opt.sidescrolloff = 10 -- keep 10 columns to left/right of the cursor
...
opt.wildmode = "longest:full,full" -- complete longest common match, full completion list, cycle through with tabs
--
