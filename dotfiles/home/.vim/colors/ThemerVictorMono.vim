if &background == 'dark'
  let s:guishade0 = "#3A3F45"
  let s:guishade1 = "#51565C"
  let s:guishade2 = "#686E74"
  let s:guishade3 = "#7F858B"
  let s:guishade4 = "#959DA2"
  let s:guishade5 = "#ACB4B9"
  let s:guishade6 = "#C3CCD1"
  let s:guishade7 = "#DAE3E8"
  let s:guiaccent0 = "#FF7272"
  let s:guiaccent1 = "#EFA280"
  let s:guiaccent2 = "#EBCB8B"
  let s:guiaccent3 = "#99C794"
  let s:guiaccent4 = "#5FBFB7"
  let s:guiaccent5 = "#7DA5D4"
  let s:guiaccent6 = "#A39AE1"
  let s:guiaccent7 = "#CF95C6"
...
if &background == 'light'
  let s:guishade0 = "#DAE3E8"
  let s:guishade1 = "#C3CCD1"
  let s:guishade2 = "#ACB4B9"
  let s:guishade3 = "#959DA2"
  let s:guishade4 = "#7F858B"
  let s:guishade5 = "#686E74"
  let s:guishade6 = "#51565C"
  let s:guishade7 = "#3A3F45"
  let s:guiaccent0 = "#CC3F3F"
  let s:guiaccent1 = "#BC6F4D"
  let s:guiaccent2 = "#9F7F3F"
  let s:guiaccent3 = "#598754"
  let s:guiaccent4 = "#2C8C84"
  let s:guiaccent5 = "#4A72A1"
  let s:guiaccent6 = "#7067AE"
  let s:guiaccent7 = "#9C6293"
  let s:ctermshade0 = 189
  let s:ctermshade1 = 188
  ...
  let s:ctermaccent6 = 103
  let s:ctermaccent7 = 139
endif

highlight clear
syntax reset
let g:colors_name = "ThemerVictorMono"
